    ...
    <div class="container-fluid my-3">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <form action="{{ route('admin-update-testimonial', $data->id) }}" method="Post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label>Name*</label>
                        ...
                        <div class="mb-3">
                            <label>Message*</label>
                            <textarea name="message" class="form-control border-3 border-secondary" placeholder="Message..." rows="5">{{ old('message')?old('message'):$data->message }}</textarea>
